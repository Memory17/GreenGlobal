...
const resources = {
  vi: {
    translation: {
      ...
      "inventory_col_discount": "Khuyến mãi",
      "inventory_stock_sufficient": "Kho đủ", "inventory_stock_warning": "Cảnh báo", "inventory_stock_low": "Sắp hết",
      "inventory_badge_new": "Mới",
      "inventory_tip_view": "Xem chi tiết", "inventory_tip_edit": "Chỉnh sửa", "inventory_tip_delete": "Xóa",
      "inventory_delete_warning": "Hành động này không thể hoàn tác",
      ...
      "inventory_label_discount_price": "Giá khuyến mãi", "inventory_placeholder_discount": "Nhập giá khuyến mãi (nếu có)",
      "inventory_preview_image": "Xem trước ảnh",
      "all_categories": "Tất cả danh mục", "low_stock": "Sắp hết hàng",
      "sort_default": "Mặc định", "price_asc": "Giá tăng", "price_desc": "Giá giảm", "stock_desc": "Tồn kho cao", "stock_asc": "Tồn kho thấp",
      "total_products": "Tổng SP", "total_stock": "Tồn kho",
      ...
      "promo_col_customer": "Khách hàng", "promo_col_level": "Cấp độ", "promo_col_current_points": "Điểm Hiện có", "promo_btn_manage_points": "Quản lý Điểm",
  ...
  en: {
    translation: {
      ...
      "inventory_col_discount": "Discount",
      "inventory_stock_sufficient": "In Stock", "inventory_stock_warning": "Warning", "inventory_stock_low": "Low Stock",
      "inventory_badge_new": "New",
      "inventory_tip_view": "View Details", "inventory_tip_edit": "Edit", "inventory_tip_delete": "Delete",
      "inventory_delete_warning": "This action cannot be undone",
      "inventory_label_name": "Product Name",
      ...
      "inventory_label_discount_price": "Discount Price", "inventory_placeholder_discount": "Enter discount price (optional)",
      "inventory_preview_image": "Image Preview",
      "all_categories": "All Categories", "low_stock": "Low Stock",
      "sort_default": "Default", "price_asc": "Price: Low to High", "price_desc": "Price: High to Low", "stock_desc": "Stock: High", "stock_asc": "Stock: Low",
      "total_products": "Total Products", "total_stock": "Total Stock",
      ...
      "promo_col_customer": "Customer", "promo_col_level": "Level", "promo_col_current_points": "Current Points", "promo_btn_manage_points": "Manage Points",
